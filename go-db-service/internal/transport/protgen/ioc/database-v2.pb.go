...
type CountBySourceAndTypeRequest struct {
	...
	Source string `protobuf:"bytes,1,opt,name=source,proto3" json:"source,omitempty"` // Источник IoC
	Type   string `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`     // Тип IoC
}
...
func (x *CountBySourceAndTypeRequest) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type CountByTypeAndSourceRequest struct {
	...
	Type   string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`     // Тип IoC
	Source string `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"` // Источник IoC
}
...
func (x *CountByTypeAndSourceRequest) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
var file_api_proto_database_v2_proto_rawDesc = []byte{
	...
	0x49, 0x0a, 0x1b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x79, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x49, 0x0a, 0x1b, 0x43, 0x6f,
	0x75, 0x6e, 0x74, 0x42, 0x79, 0x54, 0x79, 0x70, 0x65, 0x41, 0x6e, 0x64, 0x53, 0x6f, 0x75, 0x72,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x32, 0xb3, 0x06, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61,
